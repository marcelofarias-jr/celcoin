<?php
	...
	function registra_creditplataform() {

		$labels = array(
			'name'                  => _x( 'Credit Plataform', 'Credit Plataform', 'text_domain' ),
			'singular_name'         => _x( 'Credit Plataform', 'Credit Plataform', 'text_domain' ),
			'menu_name'             => __( 'Credit Plataform', 'text_domain' ),
			'name_admin_bar'        => __( 'Credit Plataform', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Credit Plataform', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'Credit Plataform', $args );

	}

	add_action( 'init', 'registra_creditplataform' );

	function cwp_register_taxonomy_creditplataform(){
		register_taxonomy(
		'creditplataform',
		array('creditplataform'),
		array(
		'label' => __('Credit Plataform'),
		'labels' => array(),
		'rewrite' => array('slug' => 'creditplataform'),
		'hierarchical' => true
		));
		}
add_action('init', 'cwp_register_taxonomy_creditplataform');
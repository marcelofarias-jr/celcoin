<?php
	...
	function registra_pagamentodecontas() {

		$labels = array(
			'name'                  => _x( 'Pagamento de Contas', 'Pagamento de Contas', 'text_domain' ),
			'singular_name'         => _x( 'Pagamento de Contas', 'Pagamento de Contas', 'text_domain' ),
			'menu_name'             => __( 'Pagamento de Contas', 'text_domain' ),
			'name_admin_bar'        => __( 'Pagamento de Contas', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Pagamento de Contas', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'Pagamento de Contas', $args );

	}

	add_action( 'init', 'registra_pagamentodecontas' );

	function cwp_register_taxonomy_pagamentodecontas(){
		register_taxonomy(
		'genero',
		array('pagamentodecontas'),
		array(
		'label' => __('Gêneros'),
		'labels' => array(),
...
add_action('init', 'cwp_register_taxonomy_pagamentodecontas');
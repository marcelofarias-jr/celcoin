<?php
/*
* Template Name: Single Saques e Depositos
*/
                ...
                <div class="box-direita bg-conteuto-produtos">
                  ...
                  <div class="box-textos <?php echo $banner['white_text'] ? 'text--white' : '' ?> col-xs-6 col-sm-12 row container">
                    <div class="box-cont-intern">
                      ...
                      <div class="box-cta">
                          <a class="button button--magenta-secondary" data-open-contact><?php echo $banner['botao_esquerda']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
                          <a class="cta-branco-especial button bg-transparent texto-azul-escuro cta-borda-azul-escuro" href="<?php echo $banner['botao_direita']['link']['url']; ?>" target="_blank"><?php echo $banner['botao_direita']['texto']; ?></a>
                      </div>
                    </div>
                  </div>
...
<section>
            ...
            <div class="box-esquerda">
                ...
                <div class="box-accordeon">
                    <div class="box-titulo sub-azul-mob">
                        <div class="titulo-medio texto-azul-escuro sub-azul-desk"><?php echo $vantagens['titulo']; ?></div>
                    </div>
    ...
    <section id="cards-impacto" class="bg-cinza">
        <div class="box-titulo sub-azul-mob">
            <div class="titulo-medio texto-azul-escuro sub-azul-desk"><?php echo $caracteristicas['titulo']; ?></div>
        </div>
        <div class="box-cards">
    ...
    <section id="carrosel-api">
        <div class="box-carrosel-geral">
            <div class="box-titulo sub-azul-mob">
                <div class="titulo-medio texto-azul-escuro sub-azul-desk"><?php echo $carrosel['titulo']; ?></div>
            </div>

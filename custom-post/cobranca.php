<?php
	...
	function registra_cobranca() {

		$labels = array(
			'name'                  => _x( 'Cobranca', 'Cobranca', 'text_domain' ),
			'singular_name'         => _x( 'Cobranca', 'Cobranca', 'text_domain' ),
			'menu_name'             => __( 'Cobranca', 'text_domain' ),
			'name_admin_bar'        => __( 'Cobranca', 'text_domain' ),
		...
		register_post_type( 'Cobranca', $args );

	}

	add_action( 'init', 'registra_cobranca' );

	function cwp_register_taxonomy_cobranca(){
		register_taxonomy(
		'cobranca',
		array('cobranca'),
		array(
		'label' => __('Cobranca'),
		'labels' => array(),
		'rewrite' => array('slug' => 'cobranca'),
		'hierarchical' => true
		));
		}
add_action('init', 'cwp_register_taxonomy_cobranca');
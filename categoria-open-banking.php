<?php
/*
* Template Name: Categoria Open Banking
*/
                ...
                <div class="box-direita bg-conteuto-produtos">
                  ...
                  <div class="box-textos <?php echo $banner_categoria['white_text'] ? 'text--white' : '' ?> col-xs-6 col-sm-12 row container">
                    <div class="box-cont-intern">
                      ...
                      <div class="box-cta">
                          <a class="button button--orange" data-open-contact><?php echo $banner_categoria['botao_esquerda']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
    ...
    <section id="banner-sub-teste">
        ...
        <div class="box-conteudo">
            ...
            <div class="box-textos <?php echo $banner['white_text'] ? 'text--white' : '' ?>">
                ...
                <div class="box-cta">
                    <a class="button button--orange-secondary-inverse" data-open-contact><?php echo $banner_sub_teste_categoria['botao']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
                </div>
            </div>
...
<section>
        ...
        <div class="box-geral">
            <div class="box-esquerda">
                ...
                <div class="box-accordeon">
                    <div class="box-titulo sub-laranja-mob">
                        <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $vantagens_categoria['titulo']; ?></div>
                    </div>
                        ...
                        <?php foreach($vantagens_categoria['accordion'] as $opcao) : ?>
                            <div class="box-opcao">
                                <button class="accordion bg-transparent">
                                    ...
                                    <div class="box-setinha bg-laranja texto-branco"><?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></div>
                                </button>
                                <div class="panel">
    ...
    <section id="cards-impacto" class="bg-cinza">
        <div class="box-titulo sub-laranja-mob">
            <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $caracteristicas_categoria['titulo']; ?></div>
        </div>
        <div class="box-cards">
    ...
    <section id="carrosel-api">
        <div class="box-carrosel-geral">
            <div class="box-titulo sub-laranja-mob">
                <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $carrosel_categoria['titulo']; ?></div>
            </div>
    ...
    <section id="bg-carrosel-produtos" class="bg-laranja"></section>

    <section id="cards-posts" class="bg-laranja">
        <div class="box-titulo sub-laranja-mob">

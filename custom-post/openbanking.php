<?php
	...
	function registra_openbanking() {

		$labels = array(
			'name'                  => _x( 'Open-Banking', 'Open-Banking', 'text_domain' ),
			'singular_name'         => _x( 'Open-Banking', 'Open-Banking', 'text_domain' ),
			'menu_name'             => __( 'Open-Banking', 'text_domain' ),
			'name_admin_bar'        => __( 'Open-Banking', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Open-Banking', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'OpenBanking', $args );

	}

	add_action( 'init', 'registra_openbanking' );

	function cwp_register_taxonomy_openbanking(){
		register_taxonomy(
		'genero',
		array('openbanking'),
		array(
...
add_action('init', 'cwp_register_taxonomy_openbanking');
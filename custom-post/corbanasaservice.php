<?php
	...
	function registra_corbanasaservice() {

		$labels = array(
			'name'                  => _x( 'Corban as a Service', 'Corban as a Service', 'text_domain' ),
			'singular_name'         => _x( 'Corban as a Service', 'Corban as a Service', 'text_domain' ),
			'menu_name'             => __( 'Corban as a Service', 'text_domain' ),
			'name_admin_bar'        => __( 'Corban as a Service', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Corban as a Service', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'Corban as a Service', $args );

	}

	add_action( 'init', 'registra_corbanasaservice' );

	function cwp_register_taxonomy_corbanasaservice(){
		register_taxonomy(
		'corbanasaservice',
		array('corbanasaservice'),
		array(
		'label' => __('Corban as a Service'),
		'labels' => array(),
		'rewrite' => array('slug' => 'corbanasaservice'),
		'hierarchical' => true
		));
		}
add_action('init', 'cwp_register_taxonomy_corbanasaservice');
<?php
	...
	function registra_transferencia() {

		$labels = array(
			'name'                  => _x( 'Transferencia', 'Transferencia', 'text_domain' ),
			'singular_name'         => _x( 'Transferencia', 'Transferencia', 'text_domain' ),
			'menu_name'             => __( 'Transferencia', 'text_domain' ),
			'name_admin_bar'        => __( 'Transferencia', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Transferencia', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'Transferencia', $args );

	}

	add_action( 'init', 'registra_transferencia' );

	function cwp_register_taxonomy_transferencia(){
		register_taxonomy(
		'transferencia',
		array('transferencia'),
		array(
		'label' => __('Transferencia'),
		'labels' => array(),
		'rewrite' => array('slug' => 'transferencia'),
		'hierarchical' => true
		));
		}
add_action('init', 'cwp_register_taxonomy_transferencia');
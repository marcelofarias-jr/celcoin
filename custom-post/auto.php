<?php
	...
	function registra_auto() {

		$labels = array(
			'name'                  => _x( 'Auto', 'Auto', 'text_domain' ),
			'singular_name'         => _x( 'Auto', 'Auto', 'text_domain' ),
			'menu_name'             => __( 'Auto', 'text_domain' ),
			'name_admin_bar'        => __( 'Auto', 'text_domain' ),
	...
	add_action( 'init', 'registra_auto' );

	function cwp_register_taxonomy_auto(){
		register_taxonomy(
		'auto',
		array('auto'),
		array(
...
add_action('init', 'cwp_register_taxonomy_auto');
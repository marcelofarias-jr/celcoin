<?php
/*
* Template Name: Categoria Transferencia
*/
  ...
  <style>
                    ...
                    <div class="box-direita bg-conteuto-produtos">
                      ...
                      <div class="box-textos <?php echo $banner_categoria['white_text'] ? 'text--white' : '' ?> col-xs-6 col-sm-12 row container">
                        <div class="box-cont-intern">
                          ...
                          <div class="box-cta">
                              <a class="button button--pink" data-open-contact><?php echo $banner_categoria['botao_esquerda']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
        ...
        <section id="banner-sub-teste">
            ...
            <div class="box-conteudo">
                ...
                <div class="box-textos <?php echo $banner['white_text'] ? 'text--white' : '' ?>">
                    ...
                    <div class="box-cta">
                        <a class="button button--pink-secondary-inverse" data-open-contact><?php echo $banner_sub_teste_categoria['botao']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
                    </div>
                </div>
        ...
        <div class="box-geral">
            <div class="box-esquerda">
                ...
                <div class="box-accordeon">
                    <div class="box-titulo sub-roxo-mob">
                        <div class="titulo-medio texto-azul-escuro sub-roxo-desk"><?php echo $vantagens_categoria['titulo']; ?></div>
                    </div>
                    ...
                    <?php foreach($vantagens_categoria['accordion'] as $opcao) : ?>
                            <div class="box-opcao">
                                <button class="accordion bg-transparent">
                                    ...
                                    <div class="box-setinha bg-roxo texto-branco"><?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></div>
                                </button>
                                <div class="panel">
    ...
    <section id="carrosel-api">
        <div class="box-carrosel-geral">
            <div class="box-titulo sub-roxo-mob">
                <div class="titulo-medio texto-azul-escuro sub-roxo-desk"><?php echo $carrosel_categoria['titulo']; ?></div>
            </div>
            ...
            <div class="box-direita">
                <img class="bg-banner banner-mobile" src="<?php echo $carrosel_categoria['imagem']['url']; ?>" alt="">
            </div>
        </div>    
    ...
    <section id="bg-carrosel-produtos" class="bg-roxo"></section>

    <section id="cards-posts" class="bg-roxo">
        <div class="box-titulo sub-roxo-mob">

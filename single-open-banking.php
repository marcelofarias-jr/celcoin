<?php
/*
* Template Name: Single Open Banking
*/
                ...
                <div class="box-direita bg-conteuto-produtos">
                  ...
                  <div class="box-textos <?php echo $banner['white_text'] ? 'text--white' : '' ?> col-xs-6 col-sm-12 row container">
                    <div class="box-cont-intern">
                      ...
                      <div class="box-cta">
                          <a class="button button--orange-secondary" data-open-contact><?php echo $banner['botao_esquerda']['texto']; ?> <?php include(dirname(__FILE__) . '/assets/vectors/chevron-down.svg'); ?></a>
...
<section>
            ...
            <div class="box-esquerda">
                ...
                <div class="box-accordeon">
                    <div class="box-titulo sub-laranja-mob">
                        <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $vantagens['titulo']; ?></div>
                    </div>
    ...
    <section id="cards-impacto" class="bg-cinza">
        <div class="box-titulo sub-laranja-mob">
            <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $caracteristicas['titulo']; ?></div>
        </div>
        <div class="box-cards">
    ...
    <section id="carrosel-api">
        <div class="box-carrosel-geral">
            <div class="box-titulo sub-laranja-mob">
                <div class="titulo-medio texto-azul-escuro sub-laranja-desk"><?php echo $carrosel['titulo']; ?></div>
            </div>
